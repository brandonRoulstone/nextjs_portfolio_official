const FooterSection = () => {
  return (
    <>
      <footer className="footer items-center p-4 bg-[rgb(18,18,18)] text-neutral-content">
            <aside className="items-center grid-flow-col">
                ...
                <p>Copyrights Brandon Roulstone © 2024 - All rights reserved | Built with Next Js.</p>
            </aside> 
